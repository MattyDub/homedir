...
(setenv "GOPATH" "/home/mygo")
(require 'go-mode)
;(add-to-list 'load-path "~/mygo/src/github.com/dougm/goflymake")
;(require 'go-flymake) ; couldn't get this working, don't know why
;(require 'go-flycheck) ; if we ever want to try flycheck, this is here too
